  ...
  <div @click.away="open = false" class="flex flex-col w-full md:w-64 text-gray-700 bg-custom-blacki dark-mode:text-gray-200 dark-mode:bg-gray-800 flex-shrink-0" x-data="{ open: false }">
    ...
    <nav :class="{'block': open, 'hidden': !open}" class="flex-grow md:block px-4 pb-4 md:pb-0 md:overflow-y-auto">
      ...
      @if(auth()->user()->role_id == 1)
                        ...
                        <x-nav-link class="block w-full px-4 py-2 mt-2 text-sm font-semibold text-gray-100 bg-transparenthover:text-gray-100 focus:text-gray-900 hover:bg-purple-900 focus:bg-custom-violet" :href="route('dashboard')" :href="route('products.customerlist')" :active="request()->routeIs('products.customerlist')">
