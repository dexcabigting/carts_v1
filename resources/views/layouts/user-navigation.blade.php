...
<div class="hidden md:flex flex-col md:flex-row h-full md:w-full">
  <div @click.away="open = false" class="flex flex-col w-full md:w-64 text-gray-700 bg-custom-violet dark-mode:text-gray-200 dark-mode:bg-gray-800 flex-shrink-0" x-data="{ open: false }">
    <div class="flex-shrink-0 px-8 py-4 flex flex-row items-center justify-center">
      <div class="items-center flex justify-center text-lg font-semibold tracking-widest text-gray-100 uppercase rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline">Adminssssss</div>
    ...
    <nav :class="{'block': open, 'hidden': !open}" class="flex-grow md:block px-4 pb-4 md:pb-0 md:overflow-y-auto">
      ...
      @if(auth()->user()->role_id == 1)
                        ...
                        <x-nav-link class="block w-full px-4 py-2 mt-2 font-semibold text-gray-100 bg-transparenthover:text-gray-100 focus:text-gray-900 hover:bg-purple-900 focus:bg-custom-violet" :href="route('dashboard')" :href="route('products.index')" :active="request()->routeIs('products.index')">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    @else
                        <x-nav-link class="text-black text-4xl focus:text-custom-violet" :href="route('dashboard')" :href="route('shop.index')" :active="request()->routeIs('shop.index')">
                            {{ __('Shop') }}
                        </x-nav-link>
