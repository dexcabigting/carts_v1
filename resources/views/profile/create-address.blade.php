<div class="p-5 ">
    <form>
        ...
        <div>
            ...
            <x-input id="home_address" class="block mt-1 w-full" type="text" placeholder="ex. Street Apartment no." required />
        </div>
        ...
        <div class="block md:flex fle-row">
            ...
            <div class="mt-4 md:ml-4">
                ...
                <x-input id="create_province-text" type="hidden" />
            </div>
        </div>
        ...
        <div class="mt-4">
            ...
            <x-input id="create_city-text" type="hidden" />
        </div>

        <div class="mt-4">
            <x-label for="create_barangay" :value="__('Barangay')"  />
            <select class="text-black rounded-lg w-full" name="create_barangay" id="create_barangay">
                <option>
                    Barangay
                </option>
            </select>
            <x-input id="create_barangay-text" type="hidden" />
        </div>
