                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr> 
                                ...
                                <td class="flex px-6 py-4 whitespace-nowrap">
                                    <div>
                                        <button wire:click.prevent="openEditCartModal({{ $userCart->product->id }})" type="button" class="p-2 bg-green-400 rounded-l-md border border-transparent font-semibold text-xs text-white uppercase tracking-wide hover:bg-green-300 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">
                                            <span>
