<div class="h-1/2 2xl:px-72 xl:px-44 md:px-24 mt-4">
<div class="" id="slider">
	<div id="line">
        ...
        <div class="mx-2 md:max-w-6xl md:mx-auto">
            <div class="shadow-xl overflow-hidden rounded-lg">
                <div class="block md:flex md:flex-row items-center md:justify-start lg:gap-5 p-6 bg-custom-blacki overflow-x-auto">
                    ...
                    <div class="mx-12 flex flex-col md:flex-row ">
                        <div class="flex  flex-col md:flex-row items-center justify-center text-base font-medium text-gray-100 py-4 my-2 md:my-0">
                    ...
                    <div class="text-white font-semibold lg:text-xl md:ml-12 text-sm my-5 md:my-0 md:text-center text-left">
                        Browse our products!
                    </div>

                    <!-- Search Bar -->
                    <div class="lg:ml-24 md:col-span-2 lg:col-span-2 grid lg:items-center lg:align-center relative md:w-64 xl:w-72 2xl:w-96">
