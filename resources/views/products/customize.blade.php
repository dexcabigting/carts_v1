				  ...
				  <div class="tab-content">
				    ...
				    <div class="tab-pane" id="tab2">
				    	<div class="well">
							...
							<div id="avatarlist">
								<img style="cursor:pointer;" class="img-polaroid" src="{{asset('images/2d-img/invisibleman.jpg')}}">
			...
			<div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
				...
				<div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
					...
					<p class="text-sm text-gray-500">
						T-shirt customization setup was exported to pdf and has been saved. Please wait until the administrator approval.
					</p>
					</div>
				</div>
				</div>
