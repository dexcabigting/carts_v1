            ...
            <div class="flex flex-row gap-5">
                <div class="w-16">
                    <div>
                        ...
                        <x-input id="xxsmall" wire:model="form.xxsmall" class="block mt-1 w-full" type="text" value="{{ old('xxsmall') }}" autofocus />
                    </div>
                    
                    <div class="mt-4">
                        <x-label for="xsmall" :value="__('XSmall')"/>
                        <x-input id="xsmall" wire:model="form.xsmall" class="block mt-1 w-full" type="text" value="{{ old('xsmall') }}" autofocus />
                    </div>

                    <div class="mt-4">
                        <x-label for="small" :value="__('Small')"/>
                        <x-input id="small" wire:model="form.small" class="block mt-1 w-full" type="text" value="{{ old('small') }}" autofocus />
                    </div>

                    <div class="mt-4">
                        <x-label for="medium" :value="__('Medium')"/>
                        <x-input id="medium" wire:model="form.medium" class="block mt-1 w-full" type="text" value="{{ old('medium') }}" autofocus />
                    </div>
                </div>
                ...
                <div class="w-16">
                    <div>
                        ...
                        <x-input id="large" wire:model="form.large" class="block mt-1 w-full" type="text" value="{{ old('large') }}" autofocus />
                    </div>

                    <div class="mt-4">
                        <x-label for="xlarge" :value="__('XLarge')"/>
                        <x-input id="xlarge" wire:model="form.xlarge" class="block mt-1 w-full" type="text" value="{{ old('xlarge') }}" autofocus />
                    </div>

                    <div class="mt-4">
                        <x-label for="xxlarge" :value="__('XXLarge')"/>
                        <x-input id="xxlarge" wire:model="form.xxlarge" class="block mt-1 w-full" type="text" value="{{ old('xxlarge') }}" autofocus />
                    </div>
                </div>
            </div>
        </div>
