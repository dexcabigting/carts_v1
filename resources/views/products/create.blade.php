            ...
            <div class="flex flex-row divide-gray-200 gap-5">
                <div class="w-48">                
                    ...
                    <div class="mt-4">
                        ...
                        <x-input wire:model.defer="form.prd_category" id="prd_category" class="block mt-1 w-full" type="text" value="{{ old('prd_category') }}" required />
                    </div>

                    <div class="mt-4">
                        <x-label for="prd_fabric" :value="__('Fabric')" />
                        <x-input wire:model.defer="form.prd_fabric" id="prd_fabric" class="block mt-1 w-full" type="text" value="{{ old('prd_fabric') }}" required />
                    </div>
