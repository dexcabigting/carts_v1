<x-guest-layout>
    <x-auth-card>
        ...
        <div class="mb-4 text-xl w-1/2 font-semibold text-center text-white">
        ...
        <div class="mt-4 flex items-center justify-between flex-col">
            <form method="POST" action="{{ route('verification.send') }}">
                ...
                <div>
                    <x-button class="hover:bg-purple-900 hover:text-purple-100 text-3xl font-semibold text-white px-12 py-6 my-6 w-full bg-custom-violet">
                        {{ __('Resend Verification Email') }}
                    </x-button>
                </div>
            </form>
            <h1 class="font-semibold text-gray-500">or</h1>
