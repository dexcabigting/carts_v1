                    ...
                    <div class="shadow overflow-hidden sm:rounded-lg">
                        <table class="table-auto min-w-full divide-y divide-gray-200 border-4 border-gray-500">
                            <thead class="bg-custom-blacki ">
                                <tr>
                                    <th scope="col" class="px-6 py-3 float-left">
                                        <div>
                                            <input type="checkbox" wire:model="selectAll" {{ (count($categories) == 0) ?  'disabled' : null }} class="rounded border-gray-100 text-indigo-600 shadow-sm focus:border-indigo-400 focus:ring-indigo-200 focus:ring-opacity-50">
                                        </div>
                                    </th>
                            ...
                            <tbody class="bg-custom-text divide-y divide-gray-200">
                                ...
                                <tr>
                                    <td class="px-6 py-4" wire:key="category-{{ $loop->index }}">
                                        <div>
                                            <input type="checkbox" wire:model="checkedCategories.{{ $category->id }}" class="rounded border-gray-400 text-indigo-600 shadow-sm focus:border-indigo-400 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                        </div>
                                    </td>
