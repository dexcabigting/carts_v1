<div id="cart-modal" class="z-10 flex flex-wrap flex-col lg:flex-row justify-items-center align-items-center absolute top-0 left-0 w-full h-full">
    <div class="py-12 fixed top-0 left-0 w-full h-full bg-gray-500 opacity-50">
    </div>

    <div class="flex flex-row p-5 m-auto z-20">
